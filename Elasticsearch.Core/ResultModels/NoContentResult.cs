...
public class NoContentResult<T> : BaseResult<T>
{
    public NoContentResult() : base()
    {
    }

    public NoContentResult(string message) => Messages.Add(message);
    ...
    public override HttpStatusCode ResultType => HttpStatusCode.NoContent;
